...
mk = [['22A1209','22A1210','22A1211','22A1212','22A1213','22A1214','22A1215','22A1216',],
        ['kalkulus dasar','pancasila','pti','bahasa','cinta dan iptek','sainster','agama kristen ','pengantar pemprograman'],
        [3,2,3,2,2,3,2,3],
...
print('6. '+'|'+'22A1214'.ljust(10)+'|'+'agama kristen '.center(26)+'|'+'3'.center(5)+'|'+'jumat'.center(8)+'|')
